...
from app.services.dto.auth import JWToken

BasicAuth = HTTPBasic()
AuthTaskHeader = APIKeyHeader(name="token", scheme_name="AuthTaskSigur", auto_error=True)
AuthUserHeader = APIKeyHeader(name="token", scheme_name="AuthUserSigur", auto_error=True)
AuthMaybeUserHeader = APIKeyHeader(name="token", scheme_name="AuthUserSigur", auto_error=False)
